...
void timer2Init(void)
{
	...
	sbi(TIMSK0, TOIE2);						// enable TCNT2 overflow
...
void timer0SetPrescaler(u08 prescale)
{
	...
	outb(TCCR0A, (inb(TCCR0A) & ~TIMER_PRESCALE_MASK) | prescale);
}
...
u16 timer0GetPrescaler(void)
{
	...
	return (pgm_read_word(TimerPrescaleFactor+(inb(TCCR0A) & TIMER_PRESCALE_MASK)));
}
...
// USB AVRs have incompatible Timer2
#if (!(defined(__AVR_AT90USB1287__) || defined(__AVR_AT90USB647__) ||  \
		defined(__AVR_AT90USB1286__) || defined(__AVR_AT90USB646__) ||  \
		defined(__AVR_ATmega16U4__)  || defined(__AVR_ATmega32U4__) ||  \
		defined(__AVR_AT90USB162__)  || defined(__AVR_AT90USB82__) ||  \
