/* Firmata_Boards.h - Hardware Abstraction Layer for Firmata library */
...
// TODO - adapt for the Micropendous Project
...
// anything else
#else
#error "Please edit Firmata_Boards.h with a hardware abstraction for this board"
#endif
